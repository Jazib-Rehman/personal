...
class Findus extends React.Component {
  ...
  render() {
    return (
      <section className="relative text-center py-24 -mb-64 z-30">
        <div className="flex h-80 bg-grid">
          <div className="md:w-5/12 hidden md:block">
            <img
              src="https://shawarmer.com/assets/common/1720x901.jpg"
        ...
        <div>
          {this.state.locators
            .filter((item, i) => i === this.state.selectedMap)
            .map((item, i) => {
              return (
                <div className="gmap_canvas" key={i} id={i}>
                  <iframe
                    className="w-full"
                    id="gmap_canvas"
                    src={"https://" + item.map}
