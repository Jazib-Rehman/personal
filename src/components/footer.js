...
class Footer extends React.Component {
  ...
  render() {
    return (
      <footer className="bg-black z-40 flex justify-center">
        <div className="absolute flex flex-wrap p-12 relative w-9/12">
          ...
          <div className="pt-5 w-full text-sec font-semibold sm:text-left sm:w-1/3 md:w-1/6 links text-sm">
            <h1 className="mt-2 font-hairline text-prim text-lg mb-6 sm:w-full font-normal">
              Quick Links
          </h1>
            <p>
          ...
          <div className="pt-5 w-full text-sec font-semibold sm:text-left sm:w-1/3 md:w-1/6 links text-sm">
            <h1 className="mt-2 w-full text-prim font-hairline text-lg mb-6 font-normal">
              Download Our App
          </h1>
